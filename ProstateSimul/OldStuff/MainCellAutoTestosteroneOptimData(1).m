...
for simulCount = 1:simulNum
    ...
    %Recording populations and drug/testo levels
    TMPop = zeros(1,time);
    TIPop = zeros(1,time);
    TPPop = zeros(1,time);
    ...
    %SAVE DATA
    save([folderName '/simulation' num2str(simulCount)],'fieldData','testoFieldData','TMPop','TIPop','TPPop','testoTracker','drugTracker', 'drugSchedule', 'testoSchedule','param')
