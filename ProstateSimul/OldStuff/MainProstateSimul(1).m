...
r_tM = 3;
r_tI = 0.6;
testosteroneHelp = 0.001;       %How much testosterone impacts tM (really same as r_tM)
...
for i = 2:stepNum+1
    ...
    tM(i) = max(r_tM*tM(i-1)*log(K/totalCells(i-1))*(tP(i-1)/totalCells(i-1))*testosterone(i-1)*testosteroneHelp,0);
