...
%Simplifying assumption: if on the edge, the
%testosterone will flow out of the system.
%Plus, we don't really care about the edges so it stays 0.
        onEdge = true;
        initialTesto(locationI,locationJ) = 0;
        finalTesto(locationI,locationJ)=0;
    end
