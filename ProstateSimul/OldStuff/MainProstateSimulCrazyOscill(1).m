...
%Coefficients
r_tPUnadj = 0.1;         %absolute growth rates (for tP)
r_tMUnadj =  1;
r_tIUnadj = 0.1;
testosteroneHelpUnadj = 0.001;       %How much testosterone impacts tM (really same as r_tM)
...
testosteroneProductionUnadj = 0.5;                 %Units Per tP
testosteroneProduction = step*testosteroneProductionUnadj;
testosteroneDecayUnadjusted = 1;            %1 is 100% %Test/day
testosteroneDecay = step * testosteroneDecayUnadjusted;     %testosterone decay per step
testosteroneConsumptionUnadj = 0.2;             %Is this a thing? UnitsTest/cell/day
