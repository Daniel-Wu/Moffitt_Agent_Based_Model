...
parfor simulCount = simulStartNum:simulEndNum
    ...
    fieldData = zeros(param.fieldSize, param.fieldSize, time, 'int8');
...
%% End of For Every Cell
       ...
       %Testing Logarithmic adjustment to testo's effects.
    ...
    cheatSave(folderName, fileName, simulCount, fieldData, testoFieldData, TMPop, TIPop, TPPop, testoTracker, drugTracker, doceTracker, PSATracker, AbiSchedule, testoSchedule, doceSchedule, param);
